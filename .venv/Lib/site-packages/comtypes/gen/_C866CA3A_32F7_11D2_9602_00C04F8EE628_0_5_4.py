...
__all__ = [
    'ISpRecoCategory', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPIAudioSizeTime', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SVSpeak', 'ISpSerializeState', 'SPWF_SRENGINE',
    'SREInterference', 'SpAudioFormat', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechGrammarWordType',
    'SPDKL_DefaultLocation', 'SECFIgnoreKanaType',
    'DISPID_SAFGetWaveFormatEx', 'SPFM_CREATE',
    'SPINTERFERENCE_TOOQUIET', 'SPEI_START_INPUT_STREAM',
    'SPEI_PHRASE_START', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SRRSetTextFeedback', '__MIDL_IWinTypes_0009',
    'SpMMAudioIn', 'SPSHT_OTHER', 'DISPID_SVPriority',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTCCITT_uLaw_8kHzMono', 'SECNormalConfidence',
    'SpeechPropertyResponseSpeed', 'DISPID_SPACommit',
    'DISPID_SASCurrentSeekPosition', 'SPSLMA', 'SGRSTTEpsilon',
    'SPAS_PAUSE', 'DISPID_SpeechVoice', 'ISpDataKey',
    'DISPID_SLPType', 'SECFDefault', 'DISPID_SRCBookmark',
    'ISpResourceManager', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPRules_NewEnum',
    'DISPID_SPPName', 'DISPID_SGRsFindRule', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechPhraseElements', 'DISPID_SWFEChannels',
    'DISPID_SPRuleNumberOfElements', 'SPINTERFERENCE_NOISE',
    'DISPID_SGRSAddWordTransition', 'ISpStreamFormatConverter',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPPFirstElement',
    'DISPID_SWFEAvgBytesPerSec', 'SVP_10', 'DISPID_SPRsItem',
    'DISPID_SRSCurrentStreamNumber', 'ISpeechPhraseRule',
    'DISPID_SRRRecoContext', 'SAFT32kHz16BitStereo', 'SpMMAudioEnum',
    'SP_VISEME_1', 'STSF_AppData', 'SVEStartInputStream',
    'DISPID_SpeechAudioFormat', 'SAFT16kHz8BitMono',
    'DISPID_SGRSRule', 'SPCS_DISABLED', 'SPPS_Interjection',
    'DISPID_SRSetPropertyString', 'DISPID_SpeechAudio',
    'DISPID_SVEEnginePrivate', 'DISPID_SVSInputSentencePosition',
    'SpSharedRecognizer', 'SpeechRecognizerState', 'SPSMF_UPS',
    'SAFT22kHz16BitMono', 'eLEXTYPE_PRIVATE12', 'ISpAudio', 'SVPOver',
    'DISPID_SpeechPhraseProperties', 'ISpObjectTokenCategory',
    'SGRSTTTextBuffer', 'SRAONone', 'SVSFIsXML',
    'ISpeechGrammarRuleStateTransitions', 'SGSDisabled',
    'SAFT11kHz8BitMono', 'DISPID_SPRuleParent', 'SRCS_Enabled',
    'ISpeechTextSelectionInformation', 'SpResourceManager',
    'SPEI_RESERVED6', 'SpeechTokenKeyAttributes', 'DISPID_SGRSTText',
    'DISPID_SPERetainedStreamOffset', 'ISpeechGrammarRuleState',
    'DISPID_SABufferNotifySize', 'SPPS_NotOverriden',
    'SVSFIsFilename', 'SPAR_Medium', 'DISPID_SOTMatchesAttributes',
    'DISPID_SPEAudioTimeOffset', 'SP_VISEME_21',
    'SREPropertyNumChange', 'SPWORDPRONOUNCEABLE', 'SP_VISEME_4',
    'SP_VISEME_6', 'ISpeechVoice', 'SpeechStreamSeekPositionType',
    'SPWORDPRONUNCIATION', 'DISPID_SPERequiredConfidence',
    'SpeechPartOfSpeech', 'SpeechDiscardType',
    'SpeechCategoryAudioIn', 'SPWORDLIST',
    'DISPID_SVESentenceBoundary', 'DISPID_SABIMinNotification',
    'DISPID_SLPs_NewEnum', 'ISpeechRecoResultTimes',
    'SDA_No_Trailing_Space', 'SPPROPERTYINFO', 'SREPhraseStart',
    'DISPID_SpeechRecoResultTimes', 'SRSEIsSpeaking',
    'DISPID_SVSCurrentStreamNumber', 'SRTSMLTimeout', 'SDTAlternates',
    'SDKLCurrentConfig', 'DISPID_SPIGrammarId',
    'SAFTCCITT_ALaw_22kHzMono', 'SECFIgnoreCase',
    'SAFT48kHz8BitStereo', 'SAFT32kHz8BitStereo', 'SP_VISEME_2',
    'SPPS_RESERVED1', 'SPSSuppressWord', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRCCmdMaxAlternates', 'STSF_LocalAppData',
    'SPPS_SuppressWord', 'SDTPronunciation', 'SPLEXICONTYPE',
    'DISPID_SPAsCount', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SASCurrentDevicePosition', 'tagSTATSTG', 'SP_VISEME_5',
    'SAFT32kHz8BitMono', 'SRSInactiveWithPurge', 'SPSFunction',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPIEngineId',
    'DISPID_SpeechPhoneConverter', 'DISPID_SOTCSetId',
    'DISPID_SpeechLexiconWords', 'eLEXTYPE_PRIVATE10',
    'SREStateChange', 'eLEXTYPE_PRIVATE1',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SLRemovePronunciation',
    'ISpRecoResult', 'DISPID_SBSFormat', 'SPRS_ACTIVE',
    'DISPID_SAFSetWaveFormatEx', 'IInternetSecurityMgrSite',
    'SPCT_DICTATION', 'SPSERIALIZEDRESULT', 'DISPID_SMSAMMHandle',
    'SRESoundStart', 'ISpeechPhraseAlternate',
    'DISPID_SRSAudioStatus', 'DISPID_SpeechPhraseRules',
    'SPWT_PRONUNCIATION', 'DISPID_SVSpeakStream',
    'DISPID_SPRuleConfidence', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SP_VISEME_10', 'SPEI_END_SR_STREAM', 'DISPID_SVSInputWordLength',
    'SRSEDone', 'DISPID_SRDisplayUI', 'DISPID_SLPsItem', 'SVP_2',
    'SpeechPropertyLowConfidenceThreshold', 'SP_VISEME_14',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SAFGuid',
    'DISPID_SRCESoundEnd', 'ISpeechRecognizerStatus', 'ISpShortcut',
    'SPBO_NONE', 'SDA_Two_Trailing_Spaces', 'SpeechLoadOption',
    'DISPID_SASFreeBufferSpace', 'SVESentenceBoundary', 'SPPS_Noun',
    'DISPID_SVSkip', 'DISPID_SWFEExtraData', 'DISPID_SFSClose',
    'DISPID_SCSBaseStream', 'ISpeechGrammarRules', 'SASRun',
    'STCInprocServer', 'DISPID_SVSLastBookmark', 'IStream',
    'DISPID_SpeechVoiceStatus', 'SRATopLevel', 'SVP_15',
    'DISPID_SRState', 'SPWAVEFORMATTYPE', 'DISPID_SRRTimes',
    'DISPID_SRCESoundStart',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpeechBaseStream',
    'SWPUnknownWordUnpronounceable', 'DISPID_SGRName',
    'ISpeechObjectToken', 'DISPID_SPEsItem', 'SPSModifier',
    'SPRST_INACTIVE', 'SPAS_RUN', 'eLEXTYPE_PRIVATE5',
    'SPEI_SR_RETAINEDAUDIO', 'SAFTADPCM_11kHzStereo',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRCRequestedUIType',
    'DISPID_SpeechFileStream', 'SPSUnknown', 'SPEI_RESERVED1',
    'DISPID_SABufferInfo', 'SpeechTokenKeyFiles',
    'DISPID_SRCreateRecoContext', 'SpeechGrammarTagDictation',
    'ISpeechLexicon', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'eLEXTYPE_PRIVATE15', 'SSTTTextBuffer', 'DISPID_SOTCDefault',
    'SAFT16kHz16BitStereo', 'ISpeechPhraseReplacements',
    'SPPS_RESERVED2', 'DISPID_SRCPause', 'DISPID_SVEViseme',
    'Speech_Default_Weight', 'STCRemoteServer',
    'DISPID_SVSInputSentenceLength', 'SVP_20', 'SVP_6',
    'DISPID_SGRsAdd', 'SP_VISEME_11', 'SPEI_MAX_TTS',
    'SpObjectTokenCategory', 'eLEXTYPE_USER_SHORTCUT',
    'SpeechTokenIdUserLexicon', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPGS_EXCLUSIVE', 'SPSEMANTICFORMAT', 'DISPID_SRRGetXMLResult',
    'SPGS_ENABLED', 'SAFT22kHz8BitStereo', 'DISPID_SVVolume',
    'SAFT44kHz16BitMono', 'SPLO_DYNAMIC', 'SGLexicalNoSpecialChars',
    'SITooFast', 'SpeechAudioState', 'SAFTGSM610_11kHzMono',
    'SAFTCCITT_uLaw_11kHzMono', 'SPDKL_CurrentConfig',
    'SVSFParseSapi', 'DISPID_SPEs_NewEnum', 'SPDKL_LocalMachine',
    'SPCT_SUB_DICTATION', 'SpeechRecoContextState', 'DISPID_SRStatus',
    'SRSActiveAlways', 'ISpeechMemoryStream',
    'SpeechCategoryRecognizers', 'SPEI_VISEME',
    'DISPID_SRCSetAdaptationData', 'DISPID_SGRSTPropertyValue',
    'eLEXTYPE_PRIVATE17', 'SPEI_TTS_PRIVATE', 'SP_VISEME_18',
    'SPBINARYGRAMMAR', 'SAFT16kHz8BitStereo',
    'DISPID_SpeechPhraseBuilder', 'SpeechRegistryUserRoot',
    'eLEXTYPE_PRIVATE11', 'SpNullPhoneConverter',
    'DISPID_SLPPartOfSpeech', 'SpMemoryStream', 'ISpEventSink',
    'SPFILEMODE', 'DISPID_SRCRetainedAudio', 'DISPID_SPIGetText',
    'DISPID_SOTDataKey', 'SPPHRASERULE', 'DISPID_SRCEPhraseStart',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFTExtendedAudioFormat',
    'SAFTCCITT_uLaw_11kHzStereo', 'SpUnCompressedLexicon',
    'SAFT24kHz8BitMono', 'SECLowConfidence', 'Speech_Max_Word_Length',
    'DISPID_SpeechRecoResult', 'IEnumSpObjectTokens',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SRTStandard',
    'SPFM_CREATE_ALWAYS', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPRuleName', 'SPCT_SUB_COMMAND', 'SpWaveFormatEx',
    'DISPID_SpeechRecoContext', 'SPLOADOPTIONS', 'SPEI_RESERVED3',
    'DISPID_SPAPhraseInfo', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SPEEngineConfidence', 'SPPS_Noncontent',
    'DISPID_SWFEBlockAlign', 'ISpeechFileStream', 'DISPID_SASetState',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SOTCategory', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPIReplacements', 'SVP_9', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SpeechAudioStatus', 'SVEAllEvents', 'ISpeechWaveFormatEx',
    'DISPID_SRSNumberOfActiveRules', 'SWTAdded', 'SPSNoun',
    'SLODynamic', 'DISPID_SVResume', 'SpeechCategoryAppLexicons',
    'SpeechVisemeType', 'SpLexicon', 'SRTAutopause',
    'SpeechTokenShellFolder', 'eLEXTYPE_RESERVED4',
    'ISpeechRecoResultDispatch', 'SVP_11', 'DISPID_SGRAttributes',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SDKSetBinaryValue', '_RemotableHandle',
    'ISpeechPhraseAlternates', 'SPPS_Verb', 'SVSFPersistXML',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPPChildren',
    'DISPID_SPPsCount', 'SAFT16kHz16BitMono', 'SRADynamic',
    'DISPID_SRGRules', 'SpeechEmulationCompareFlags',
    'SpeechRecoProfileProperties', 'SPVOICESTATUS',
    'STSF_CommonAppData', 'SP_VISEME_0', 'SAFTText',
    'SRAORetainAudio', 'DISPID_SLPLangId', 'SAFT44kHz8BitStereo',
    'SpeechGrammarRuleStateTransitionType', 'SPRECORESULTTIMES',
    'eLEXTYPE_USER', 'SPXMLRESULTOPTIONS',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRRAudio', 'DISPID_SGRId',
    'SAFTCCITT_ALaw_44kHzMono', 'SP_VISEME_3', 'SAFT32kHz16BitMono',
    'SDTReplacement', 'SVF_Stressed', 'SPFM_OPEN_READWRITE',
    'SAFTADPCM_44kHzMono', 'UINT_PTR', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRIsUISupported', 'SRSInactive', 'SPSHT_NotOverriden',
    'eLEXTYPE_RESERVED6', 'SAFTCCITT_ALaw_44kHzStereo',
    'SAFTADPCM_8kHzMono', 'DISPID_SRGCmdLoadFromMemory',
    'SPPHRASEELEMENT', 'DISPID_SVSLastResult', 'DISPID_SVEAudioLevel',
    'SGDSActive', 'DISPID_SFSOpen', 'DISPID_SVSVisemeId',
    'ISpeechLexiconPronunciations', 'ISpeechRecoResult2',
    'DISPID_SGRSTsCount', 'DISPID_SOTCGetDataKey',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRCEHypothesis', 'SVP_5', 'SGDSInactive',
    'DISPID_SVSRunningState', 'DISPID_SDKOpenKey',
    'SAFT12kHz8BitStereo', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SGRSTRule', 'DISPID_SDKEnumValues', 'SVSFIsNotXML',
    'SPEI_TTS_BOOKMARK', 'DISPID_SPAsItem', 'DISPID_SVGetAudioInputs',
    'DISPID_SPCLangId', 'SITooSlow', 'SPEI_SR_BOOKMARK',
    'SAFT48kHz8BitMono', 'SVP_19', 'DISPID_SLGetPronunciations',
    'SPRULE', 'SP_VISEME_13', 'DISPID_SpeechPhraseReplacements',
    'SPEVENTENUM', 'DISPID_SVStatus', 'DISPID_SDKEnumKeys',
    'SAFT8kHz8BitMono', 'DISPID_SRCVoice', 'DISPID_SVIsUISupported',
    'ISpeechDataKey', 'SPEI_FALSE_RECOGNITION', 'DISPID_SGRSTWeight',
    'DISPID_SpeechRecoContextEvents', 'SAFTADPCM_8kHzStereo',
    'ISpeechAudioFormat', 'SWTDeleted', 'SPPS_RESERVED3',
    'DISPID_SRSClsidEngine', 'DISPID_SAEventHandle',
    'DISPID_SPAs_NewEnum', 'DISPID_SGRSAddSpecialTransition',
    'SBONone', 'SpeechVoicePriority', 'SDKLDefaultLocation',
    'DISPID_SLWs_NewEnum', 'SpeechAudioFormatGUIDText',
    'DISPID_SRCEPropertyNumberChange', 'SPPHRASEPROPERTY',
    'SpInProcRecoContext', 'DISPID_SGRSTType', 'DISPID_SGRsItem',
    'SPPS_Function', 'SPPS_LMA', 'DISPID_SRGetFormat',
    'DISPID_SPEDisplayText', 'SPEI_UNDEFINED', 'SpPhoneConverter',
    'eLEXTYPE_PRIVATE3', 'SpPhraseInfoBuilder', 'DISPID_SVEPhoneme',
    'DISPID_SRCResume', 'ISpeechObjectTokenCategory',
    'DISPID_SDKDeleteKey', 'DISPID_SLWsCount', 'SPBO_AHEAD',
    'ISpRecognizer', 'DISPID_SVWaitUntilDone', 'SREAdaptation',
    'SRTExtendableParse', 'DISPID_SPEDisplayAttributes', 'ISpPhrase',
    'SAFT24kHz16BitStereo', 'SPCATEGORYTYPE', 'SSFMCreateForWrite',
    'SPSHT_EMAIL', 'SPSHORTCUTPAIRLIST', 'SLTApp',
    'DISPID_SLPPhoneIds', 'SAFT12kHz8BitMono',
    'SpeechCategoryRecoProfiles', 'SpeechEngineProperties',
    'ISpeechPhraseRules', 'DISPID_SRRSpeakAudio',
    'DISPID_SVSLastBookmarkId', 'eLEXTYPE_PRIVATE14',
    'SSSPTRelativeToEnd', 'SPVPRI_OVER', 'DISPID_SOTId',
    'SSFMOpenReadWrite', 'SPCONTEXTSTATE',
    'DISPID_SpeechMemoryStream', 'SpeechGrammarTagUnlimitedDictation',
    'SpeechBookmarkOptions', 'DISPID_SGRsDynamic',
    'SECFEmulateResult', 'SPEI_END_INPUT_STREAM',
    'DISPID_SADefaultFormat', 'STCInprocHandler',
    'DISPID_SLWPronunciations', 'SAFTADPCM_11kHzMono',
    'DISPID_SDKGetBinaryValue', 'DISPID_SVAudioOutput',
    'SpCustomStream', 'SPINTERFERENCE_TOOLOUD',
    'SPEI_START_SR_STREAM', 'eWORDTYPE_ADDED',
    'DISPIDSPTSI_ActiveOffset', 'SPRECOSTATE', 'ISpLexicon',
    'DISPID_SPERetainedSizeBytes', 'SpeechTokenContext',
    'DISPID_SPEAudioStreamOffset', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechMMSysAudio', 'SSTTWildcard',
    'SPWORDPRONUNCIATIONLIST', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPEI_MAX_SR', 'DISPID_SRSSupportedLanguages',
    'SpeechAudioVolume', 'SAFTCCITT_ALaw_8kHzMono',
    'eLEXTYPE_RESERVED9', 'SPVPRI_NORMAL', 'SPAR_Unknown',
    'DISPID_SpeechPhraseAlternates', 'SpeechSpecialTransitionType',
    'SFTInput', 'DISPID_SREmulateRecognition',
    'DISPID_SOTIsUISupported', 'DISPID_SMSADeviceId',
    'DISPID_SRGCommit', 'DISPID_SWFESamplesPerSec',
    'ISpeechPhraseInfo', 'SVSFParseSsml', 'SPSTREAMFORMATTYPE',
    'SREAudioLevel', 'DISPID_SPIAudioStreamPosition',
    ...
    'SpeechDataKeyLocation', 'SPCT_COMMAND',
    'SpPhoneticAlphabetConverter', 'SRAExport',
    'ISpeechPhraseReplacement', 'DISPID_SpeechPhraseElement',
    'DISPID_SRCEStartStream', 'SASClosed', 'SAFT44kHz16BitStereo',
    'DISPID_SAFType', 'SDTAudio', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SASNonBlockingIO', 'DISPID_SRRTStreamTime', 'SPPHRASE',
    'SVP_21', 'SpeechWordType', 'SPXRO_SML', 'SpeechStreamFileMode',
    'DISPID_SRGSetWordSequenceData', 'SAFT48kHz16BitStereo',
    'IInternetSecurityManager', 'SGRSTTDictation',
    'SAFTADPCM_22kHzStereo', 'SPAR_High',
    'DISPID_SRCCreateResultFromMemory', 'SPSEMANTICERRORINFO',
    'SpeechVisemeFeature', 'SPAUDIOSTATE', 'DISPID_SVEWord',
    'SPSMF_SAPI_PROPERTIES', 'SPPARTOFSPEECH',
    'DISPID_SDKSetLongValue', 'DISPID_SGRClear', 'ISpeechLexiconWord',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SDKCreateKey', 'SpeechCategoryPhoneConverters',
    'DISPID_SVGetAudioOutputs', 'ISpNotifySink', 'SpeechLexiconType',
    'SPEI_RECO_OTHER_CONTEXT', 'SAFT11kHz16BitStereo',
    'ISpeechRecoGrammar', 'DISPID_SVEStreamStart', 'ISpProperties',
    'SVPAlert', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SRRDiscardResultInfo', 'ISpeechObjectTokens',
    'SAFTNonStandardFormat', 'DISPID_SPEAudioSizeBytes',
    'SVEBookmark', 'SpShortcut', 'SDA_Consume_Leading_Spaces',
    'SSFMCreate', 'SpInprocRecognizer', 'DISPID_SRCEventInterests',
    'ISpPhoneConverter', 'SRTReSent', 'DISPID_SDKSetStringValue',
    'SPEI_RESERVED2', 'DISPID_SPPConfidence', 'DISPID_SRIsShared',
    'SAFT12kHz16BitMono', 'SVP_4', 'ISpRecognizer3',
    'DISPID_SpeechRecognizer', 'SPSHORTCUTPAIR', 'SGSExclusive',
    'DISPID_SPARecoResult', 'SpeechTokenValueCLSID', 'SP_VISEME_20',
    'SRADefaultToActive', 'SPINTERFERENCE_TOOFAST', 'SVEVoiceChange',
    'SpeechPropertyResourceUsage', 'DISPID_SPRs_NewEnum',
    'SGSEnabled', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SPIElements', 'SpeechPropertyAdaptationOn',
    'SPSERIALIZEDPHRASE', 'SPAO_NONE', 'SPRST_NUM_STATES',
    'SPEI_HYPOTHESIS', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_RECOGNITION',
    'SREFalseRecognition', 'DISPID_SLPsCount', 'DISPIDSPTSI',
    'DISPID_SGRsCount', 'SVSFParseAutodetect', 'SPEI_SOUND_END',
    'DISPID_SPIProperties', 'SDTRule', 'DISPID_SRCState',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SGRs_NewEnum',
    'eLEXTYPE_PRIVATE6', 'SpeechTokenKeyUI', 'DISPID_SPILanguageId',
    'SREHypothesis', 'SP_VISEME_12', 'eWORDTYPE_DELETED', 'SRAImport',
    'ISpeechAudioBufferInfo', 'ISpeechPhraseProperty',
    'DISPID_SOTGetDescription', 'DISPID_SOTSetId',
    'DISPID_SGRSTsItem', 'SRESoundEnd', 'SpeechCategoryAudioOut',
    'SVP_8', 'SpeechMicTraining', 'DISPID_SASState', 'SVSFParseMask',
    'SAFTGSM610_22kHzMono', 'ISpeechVoiceStatus', 'SINone',
    'SpStream', 'SpeechDictationTopicSpelling', 'eLEXTYPE_RESERVED7',
    'DISPID_SPPParent', 'SVEPrivate', 'Speech_StreamPos_Asap',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SDKGetlongValue',
    'DISPID_SpeechCustomStream', 'DISPID_SMSALineId', 'SITooQuiet',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPPEngineConfidence',
    'DISPID_SVAudioOutputStream', 'SP_VISEME_8',
    'DISPID_SRRGetXMLErrorInfo', 'SVP_13', 'SpeechAudioFormatType',
    'ISpeechLexiconWords', 'DISPID_SpeechVoiceEvent',
    'ISpeechPhraseElements', 'SpCompressedLexicon',
    'SPGRAMMARWORDTYPE', 'DISPID_SRGetRecognizers', 'SASStop',
    'SPINTERFERENCE', 'DISPID_SRCEEndStream', 'ISpMMSysAudio',
    'DISPIDSPTSI_ActiveLength', 'SSTTDictation', 'ISpPhraseAlt',
    'SGRSTTRule', 'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPSHORTCUTTYPE',
    'SAFT22kHz8BitMono', 'DISPID_SpeechObjectTokens',
    'DISPID_SRCRecognizer', 'SDTLexicalForm', 'SREStreamStart',
    'DISPID_SLGetGenerationChange', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SWFEFormatTag', 'eLEXTYPE_PRIVATE16', 'SpeechRuleState',
    'SVP_0', 'SPEI_PHONEME', 'SPEI_ADAPTATION', 'DISPID_SRRTLength',
    'SPEI_MIN_SR', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRCERecognitionForOtherContext', 'SAFT11kHz8BitStereo',
    'SWPUnknownWordPronounceable', 'SPRECOCONTEXTSTATUS',
    'SpeechRunState', 'DISPID_SRAudioInputStream', 'ISpStream',
    'eLEXTYPE_RESERVED8', 'SPEI_SOUND_START', 'SPSNotOverriden',
    'ISpeechMMSysAudio', 'SpeechRuleAttributes',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SOTCId',
    'DISPID_SBSWrite', 'SPXRO_Alternates_SML',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SMSSetData',
    'SVSFVoiceMask', 'SPAUDIOSTATUS', 'Speech_Max_Pron_Length',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechAllElements',
    'DISPID_SVVoice', 'DISPID_SOTCreateInstance',
    'DISPID_SpeechPhraseReplacement', 'SVP_3', 'SRERecognition',
    'ISpStreamFormat', 'SP_VISEME_9', 'tagSPTEXTSELECTIONINFO',
    'SREAllEvents', 'SGDisplay', 'DISPID_SPPId', 'SPWORDTYPE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRRAudioFormat', 'ISpeechResourceLoader', 'DISPIDSPRG',
    'SpeechRetainedAudioOptions', 'ISpeechPhoneConverter',
    'SpeechCategoryVoices', 'ISpPhoneticAlphabetSelection',
    'DISPID_SGRSTPropertyName', 'SPAUDIOOPTIONS',
    'DISPID_SVSLastStreamNumberQueued', 'SREPropertyStringChange',
    'DISPID_SMSGetData', 'SAFT48kHz16BitMono', 'SPEI_WORD_BOUNDARY',
    'SINoise', 'DISPID_SpeechObjectToken',
    'ISpeechLexiconPronunciation', 'SPDKL_CurrentUser',
    'SpeechDisplayAttributes', 'SPEI_TTS_AUDIO_LEVEL',
    'ISpRecoGrammar2', 'SP_VISEME_16',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpNotifySource',
    'SPVPRI_ALERT', 'DISPID_SRRPhraseInfo',
    'DISPID_SRGDictationUnload', 'SECHighConfidence', 'SPWF_INPUT',
    'DISPID_SGRAddResource', 'DISPID_SRGReset',
    'DISPID_SGRInitialState', 'SAFTGSM610_44kHzMono', 'SPWT_LEXICAL',
    'SVP_7', 'SP_VISEME_19', 'SDTProperty', 'DISPID_SPELexicalForm',
    'SPAUDIOBUFFERINFO', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRAudioInput', 'SGRSTTWildcard', 'eLEXTYPE_PRIVATE13',
    'SPINTERFERENCE_NONE', 'SpeechWordPronounceable',
    'SGDSActiveUserDelimited', 'SITooLoud', 'SPSHT_Unknown',
    'SGPronounciation', 'SRTEmulated', 'DISPID_SOTRemove',
    'DISPID_SpeechRecognizerStatus', 'SP_VISEME_17', 'SVF_Emphasis',
    'ISpeechRecoContext', 'SDKLCurrentUser',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRGId',
    'SpeechAudioProperties', 'DISPID_SPRuleId', 'SLTUser',
    'ISpRecoContext2', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRCEFalseRecognition', 'SGLexical', 'SPTEXTSELECTIONINFO',
    'SVF_None', 'DISPID_SpeechXMLRecoResult', 'DISPID_SPRuleChildren',
    'DISPID_SPIStartTime', 'DISPID_SPEPronunciation',
    'DISPID_SVGetVoices', 'DISPID_SOTGetStorageFileName',
    'SpObjectToken', 'SpeechRecognitionType', 'SpVoice',
    'SPDATAKEYLOCATION', 'SFTSREngine', 'SPGS_DISABLED',
    'SSFMOpenForRead', 'DISPID_SRGDictationLoad', 'SVSFDefault',
    'DISPID_SpeechPhraseAlternate', 'SVEPhoneme',
    'eLEXTYPE_RESERVED10', 'SRCS_Disabled', 'SAFT24kHz16BitMono',
    'SDKLLocalMachine', 'SpeechGrammarTagWildcard', 'SPEI_RESERVED5',
    'WAVEFORMATEX', 'SpeechVoiceEvents',
    'DISPID_SPAStartElementInResult', 'SPEI_VOICE_CHANGE',
    'DISPID_SPIEnginePrivateData', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRCRetainedAudioFormat', 'SPEVENT',
    'DISPID_SPRFirstElement', 'DISPID_SPRuleEngineConfidence',
    'SVEEndInputStream', 'SPEI_MIN_TTS',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SDA_One_Trailing_Space', 'DISPID_SRGetPropertyNumber',
    'SPRS_INACTIVE', 'SPPS_RESERVED4', 'DISPID_SRGetPropertyString',
    'ISpeechAudio', 'DISPID_SVAlertBoundary', 'ISequentialStream',
    'DISPID_SRCEEnginePrivate', 'SAFT8kHz16BitMono',
    'DISPID_SpeechDataKey', 'SPRST_INACTIVE_WITH_PURGE',
    'SPPS_Unknown', 'SVSFUnusedFlags', 'SpeechEngineConfidence',
    'eLEXTYPE_PRIVATE20', 'STCLocalServer',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPCPhoneToId', 'SVP_1',
    'ISpNotifyTranslator', 'SpeechAddRemoveWord',
    'DISPID_SpeechLexiconProns', 'DISPID_SRCERecognition', 'LONG_PTR',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVRate', 'SPEI_INTERFERENCE',
    'SRERecoOtherContext', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SVEventInterests',
    'SpeechFormatType', 'DISPID_SLWWord', 'DISPID_SLWsItem',
    'SRARoot', 'SAFT44kHz8BitMono', 'DISPID_SABIEventBias',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPRText', 'SINoSignal',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPRuleFirstElement',
    'SPEVENTSOURCEINFO', 'ISpeechPhraseElement', 'SVP_17',
    'DISPID_SRCEBookmark', 'SVSFNLPSpeakPunc',
    'DISPID_SpeechBaseStream', 'DISPID_SOTDisplayUI',
    'SSSPTRelativeToCurrentPosition', 'SREStreamEnd',
    '_ISpeechRecoContextEvents', 'DISPID_SRRecognizer',
    'SPEI_SR_PRIVATE', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SpeechRecoResult2', 'DISPID_SRGState', 'SpeechRecoEvents',
    'DISPID_SRGIsPronounceable', 'IEnumString', 'DISPID_SPRsCount',
    'ISpeechRecoResult', 'SPWT_DISPLAY', 'SREPrivate', 'SPCS_ENABLED',
    'DISPID_SAVolume', 'DISPID_SRGSetTextSelection',
    'SPBO_TIME_UNITS', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPPs_NewEnum', 'DISPID_SpeechLexicon', 'SRSActive',
    'SWPKnownWordPronounceable', 'SAFT8kHz16BitStereo',
    'SPBOOKMARKOPTIONS', '_SPAUDIOSTATE', 'SVP_14', 'SPRST_ACTIVE',
    'SVPNormal', 'DISPID_SVGetProfiles', 'SpFileStream',
    'SPRULESTATE', 'ISpRecognizer2', 'ISpGrammarBuilder',
    'DISPID_SLGetWords', 'SGRSTTWord', 'DISPID_SRCEInterference',
    'DISPID_SRCCreateGrammar', 'ISpObjectWithToken',
    'DISPID_SGRSTNextState', 'ISpVoice', 'STSF_FlagCreate',
    'DISPID_SVEVoiceChange', 'SPVISEMES', 'SPPS_Modifier',
    'ISpeechAudioStatus', 'SpeechVoiceSpeakFlags', 'SPFM_NUM_MODES',
    'DISPIDSPTSI_SelectionOffset', 'eLEXTYPE_APP',
    'DISPID_SABIBufferSize', 'SpNotifyTranslator', 'ISpObjectToken',
    'DISPID_SPEActualConfidence', 'SRERequestUI', 'eLEXTYPE_PRIVATE8',
    'DISPID_SGRSTransitions', 'DISPID_SPPValue', 'SpeechGrammarState',
    'DISPID_SRGDictationSetState', 'DISPID_SLAddPronunciation',
    'DISPID_SPRulesItem', 'SVEViseme', 'SPWORD',
    'DISPID_SRCERequestUI', 'SPVPRIORITY', 'DISPID_SRRTTickCount',
    'DISPID_SRRTOffsetFromStart', 'SpeechVoiceSkipTypeSentence',
    'ISpeechXMLRecoResult', 'DISPID_SDKGetStringValue',
    'DISPID_SDKDeleteValue', 'ISpRecoGrammar', 'ISpeechGrammarRule',
    'DISPID_SVEStreamEnd', 'STCAll', 'DISPID_SOTsCount',
    'SGDSActiveWithAutoPause', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SOTs_NewEnum',
    'SAFT11kHz16BitMono', 'SPEI_REQUEST_UI',
    'SpStreamFormatConverter', 'DISPID_SVEBookmark', 'SASPause',
    'SRAInterpreter', '_ISpeechVoiceEvents', 'SAFT8kHz8BitStereo',
    'SP_VISEME_15', 'ISpXMLRecoResult', 'DISPID_SRSetPropertyNumber',
    'SECFIgnoreWidth', 'SPFM_OPEN_READONLY', 'DISPID_SRCEAudioLevel',
    'DISPID_SLPSymbolic', 'DISPID_SPCIdToPhone',
    'SpeechPropertyHighConfidenceThreshold', 'SAFTDefault',
    'SPAO_RETAIN_AUDIO', 'DISPID_SGRsCommit', 'SPCT_SLEEP',
    'DISPID_SVSPhonemeId', 'SVP_12', 'DISPID_SVDisplayUI',
    'DISPID_SPRNumberOfElements', 'DISPID_SPEsCount', 'SBOPause',
    'ISpRecoContext', 'DISPID_SBSRead', 'SP_VISEME_7', 'SVP_18',
    'SAFTNoAssignedFormat', 'SECFNoSpecialChars',
    'SpeechUserTraining', 'DISPID_SRCEAdaptation', 'ISpEventSource',
    ...
    'SPRECOGNIZERSTATUS', 'SpTextSelectionInformation',
    'DISPID_SpeechPhraseRule', 'DISPID_SGRsCommitAndSave',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SpeechWaveFormatEx', 'SVSFlagsAsync',
    'SpeechAudioFormatGUIDWave', 'SAFT22kHz16BitStereo',
    'DISPID_SPEAudioSizeTime', 'DISPID_SOTGetAttribute',
    'DISPID_SLWType', 'Speech_StreamPos_RealTime', 'DISPID_SPPsItem',
    'DISPID_SLGenerationId', 'DISPID_SRGRecoContext',
    'DISPID_SRRSaveToMemory', 'DISPID_SGRSTPropertyId',
    'SpeechInterference', 'SPBO_PAUSE', 'SPAS_STOP',
    'DISPID_SRProfile', 'DISPID_SGRAddState', 'DISPID_SRRAlternates',
    'SPEI_RECO_STATE_CHANGE', 'SREBookmark', 'SPLO_STATIC',
    'eLEXTYPE_PRIVATE9', 'ISpPhoneticAlphabetConverter', 'SVP_16',
    'SVEWordBoundary', 'DISPID_SVPause', 'DISPID_SpeechLexiconWord',
    'SPPHRASEREPLACEMENT', 'SAFT12kHz16BitStereo', 'SPSVerb',
    'SAFTCCITT_uLaw_44kHzMono', 'eLEXTYPE_PRIVATE7',
    'SPSInterjection', 'SPAR_Low', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SOTsItem', 'DISPIDSPTSI_SelectionLength',
    'SPGRAMMARSTATE', 'ISpeechCustomStream', 'SSSPTRelativeToStart',
    'SAFTADPCM_44kHzStereo', 'DISPID_SVSInputWordPosition', 'SDTAll',
    'DISPID_SPIRule', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SPISaveToMemory', 'DISPID_SPRulesCount',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SAStatus',
    'SpSharedRecoContext', 'SAFTGSM610_8kHzMono', 'ISpeechRecognizer',
    'DISPID_SPPNumberOfElements', 'SpMMAudioOut', 'SPAS_CLOSED',
    'tagSPPROPERTYINFO', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SpeechPhraseInfo', 'SVSFNLPMask',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SLOStatic',
    'DISPID_SRCAudioInInterferenceStatus', 'SDTDisplayText'
]

_check_version('1.2.1', 1701657989.690187)
